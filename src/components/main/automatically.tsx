    ...
    <div className="my-40 flex items-center justify-center">
        <div className="w-[90vw]">
          ...
          <div className="flex flex-col lg:flex-row justify-between mt-10">
            <div className="sm:text-lg text-base text-[#A1A1AA] lg:w-[45%] w-[90vw]">
              ...
              <div className="mt-10 flex items-center text-sm">
                <span className="rounded-full border border-white mr-2"> <Check className="w-3 h-3" /></span> Fully public and customizable
              </div>
              <div className="mt-2 flex items-center text-sm">
                <span className="rounded-full border border-white mr-2"> <Check className="w-3 h-3" /></span> Detailed test scenarios for UI questions
              </div>
            </div>
