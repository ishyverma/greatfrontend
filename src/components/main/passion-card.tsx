  ...
  return (
    <div className="flex flex-col items-center justify-center pb-40">
      <div className="flex items-center justify-center">
        <p className="text-[#DDDCDD] mt-20 text-center sm:text-5xl text-3xl font-medium sm:w-[750px] w-80">
      ...
      <div className="flex items-center justify-center mt-20 relative w-auto">
        ...
        <Card className="sm:w-[550px] w-[90vw]">
          <CardContent className="pt-6">
            <div className="text-[#DDDCDD] text-base">
            ...
            <div className="text-[#DDDCDD] text-base mt-6">
          ...
          <CardFooter>
            <div className="flex items-center justify-between w-full">
              <div>
                <div className="text-[#DDDCDD] flex items-center gap-1 text-base cursor-pointer hover:underline">
                  <Link
                ...
                <div className="text-xs mt-2 text-[#A1A1AA] text-medium">
