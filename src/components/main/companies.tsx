  ...
  return (
    <div className="my-40 flex items-center justify-center">
      <div className="w-[90vw]">
        <div className="sm:text-5xl text-3xl text-[#F4F4F4] sm:w-[900px] w-[90vw] font-medium">
          Leverage insider tips from leading companies
        </div>
        <div className="sm:text-lg text-base text-[#A1A1AA] sm:w-[55%] w-[90vw] sm:mt-10 mt-5">
